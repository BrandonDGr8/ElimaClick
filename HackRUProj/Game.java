...
//				for (int col = 0; col < 9; col++) {
//					temp = grid[row][col];
//					if (col < 9 && (temp.getImage()).equals(grid[row][col+1].getImage())){
//						multiplier++;
//						if (multiplier > 2){
//							fallingBlocks.set(fallingBlocks.indexOf(grid[row][col+1]), null);
//							grid[row][col+1] = null;
...
//						}
//					}
//					if (col>0 && (temp.getImage()).equals(grid[row][col-1].getImage())){
//						multiplier++;
//						if (multiplier > 2){
//							fallingBlocks.set(fallingBlocks.indexOf(grid[row][col-1]), null);
//							grid[row][col-1] = null;
...
//						}
//					}
//					if (row < 14 && (temp.getImage()).equals(grid[row+1][col].getImage())){
//						multiplier++;
//						if (multiplier > 2){
//							fallingBlocks.set(fallingBlocks.indexOf(grid[row+1][col]), null);
//							grid[row+1][col] = null;
...
//						}
//					}
//					if (row > 1 && (temp.getImage()).equals(grid[row-1][col].getImage())){
//						multiplier++;
//						if (multiplier > 2){
//							fallingBlocks.set(fallingBlocks.indexOf(grid[row-1][col]), null);
//							grid[row-1][col] = null;
